...
//   try {
//     const cliente = await Empresa.find();
...
//     const cliente = await Empresa.findById(id);
//     console.log(cliente);
...
// Ruta GET para consular nombre de la empresa.
router.get('/nombreEmpresa', consultaNombreEmpresa)
...
//   try {
//     const id = req.params.id;
//     const eliminarCliente = await Empresa.findByIdAndDelete(id);
//     if (!eliminarCliente)
...
//      */
//     const actualizarCliente = await Empresa.findByIdAndUpdate(
//       id,
//       req.body,
//       { new: true }
//     );
